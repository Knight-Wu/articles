...
* prepare 阶段
proposer  发出一个message , 只包含一个独特的编号为 n, 若acceptor 没有接受过或者接受过, 则回复不会再响应小于n 的ProposeID, 并回复proposer, 若 acceptor 接受过任何propose, 包含编号为m，value为 Mv, 若m >n , 则不回复 proposer; 若m < n, 则将编号m, 和Mv(两个作为promise )返回给proposer
* accept 阶段
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0MDk4NjkyMSw1NjQyMzgxNyw0ODM1Mj
