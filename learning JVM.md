...
Young Generation size 越大, minor gc 频率越低, jingsheng老年就会越小(永久代 + 年轻代等于 heap size), major 会越频繁, major 通常会引起minor , 就是一次full gc.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDUxODUwMzIsLTEyOTYxMzY4NTQsLT
