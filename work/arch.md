...
减少不均衡程度，理论上完全均衡就是shard 数是节点数的整数倍，然后每个索引都分配这么多shard，但是会带来shard 数增加，master负担过重，
...
理论上，假设每个大集群，分3，四节点的集群，5，6节点的集群，8 节点的集群,10,12，16 节点的集群，多分一点，然后就按照这个梯度来分索引，当写入量增加了，就从4 节点的写到6 节点的这样依次增加，但是有可能就是4 节点的承受不了几个索引，因为机器少，然后一直增加shard 直至满足写入， 导致集群shard 数比较多，master 负担重。
