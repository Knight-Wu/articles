...
查询的时间复杂度等于跳表的高度乘每层高度比较的次数, 是 O(lgn), n 为元素个数, 近似为二分查找, 等同于跳表的高度, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxMDgyMDA0LDUxNjA0NDAwNywxNDA4ND
EzNDgwLDEzODIzNTg0ODgsNjkwMjY0OTcwLC04MzA4MTk5ODks
MTcxNzQ1NjI2MywtMTUxNjU0NjM4M119
-->