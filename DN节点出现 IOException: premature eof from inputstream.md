...
1. 确保前一个连接A 发的消息因为网络阻塞,  A连接关闭后, 仍然被后续新建的连接(源ip, 源端口, 目的ip, 目的端口)收到
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyMTE0NTExOCwtMTY3ODU1OTE1Niw0ND
k3NTQxNjksLTE1NjEwMDM1MiwyMDAyOTQ4MjE5XX0=
-->